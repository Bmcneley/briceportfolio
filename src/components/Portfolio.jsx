...
import nasaUsliCover from "../assets/nasapayload/IMG_3386.JPG";
import midAmericanCover from "../assets/midamerican/IMG_0514.jpg";
import aeronimbusCover from "../assets/aeronimbus/aeronimbus_3.png";
      ...
      >
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          >
            ...
            <div className="p-5">
              <h3 className="text-lg font-semibold text-white">NASA USLI</h3>
            </div>
          </Link>
